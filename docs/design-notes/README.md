...
- **`report-goal-fanout-workflow.md`** — shared flow design for goal completion topologies: direct, serial, parallel fan-out/fan-in, aggregation-required, owner resource gates, coordinator dispatch, reviewed memory, and final goal closure.
