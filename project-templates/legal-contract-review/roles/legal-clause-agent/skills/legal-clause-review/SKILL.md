...
- Write the first-pass review to the exact shared path provided by the lead, normally `待复审核/<source-name>-初审.md`.
...
Do not substitute a local file under `/opt/data/workspace` when the assignment names `待复审核/`.
